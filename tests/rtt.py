...
_rtt_tests = dict(
    ...
    texture_depth=dict(texture_ds_format='depth'),
    texture_depth_stencil=dict(texture_ds_format='depth_stencil'),
    texture_depth_msaa=dict(texture_ds_format='depth', samples=4),
    texture_depth_stencil_msaa=dict(texture_ds_format='depth_stencil', samples=4),
)
