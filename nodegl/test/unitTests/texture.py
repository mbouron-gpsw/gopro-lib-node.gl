...
_RENDER_TO_CUBEMAP_VERT = 'rttCubemap.vert'
_RENDER_TO_CUBEMAP_FRAG = 'rttCubemap.frag'

_RENDER_CUBEMAP_VERT = 'textureCube.vert'
_RENDER_CUBEMAP_FRAG = 'textureCube.frag'

def _get_texture_cubemap_from_mrt_scene(cfg, samples=0):

    render_to_cubemap_vert = _RENDER_TO_CUBEMAP_VERT
    render_to_cubemap_frag = _RENDER_TO_CUBEMAP_FRAG
    ...
    render_cubemap_vert = _RENDER_CUBEMAP_VERT
    render_cubemap_frag = _RENDER_CUBEMAP_FRAG
...
_TEXTURE3D_VERT = 'texture3D.vert'
_TEXTURE3D_FRAG = 'texture3D.frag'
...
def texture_3d(cfg):
    ...
    render_cubemap_vert = _TEXTURE3D_VERT
    render_cubemap_frag = _TEXTURE3D_FRAG
...
_RENDER_TEXTURE_LOD_VERT = 'textureLOD.vert'
_RENDER_TEXTURE_LOD_FRAG = 'textureLOD.frag'
...
def texture_mipmap(cfg, show_dbg_points=False):
    ...
    program = ngl.Program(
        vertex=_RENDER_TEXTURE_LOD_VERT,
