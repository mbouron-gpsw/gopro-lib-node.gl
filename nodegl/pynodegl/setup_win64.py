...
extensions = [
	Extension("pynodegl", ["pynodegl.pyx"], 
		...
		library_dirs=[f"../../cmake-build-debug/ngfx/Debug", f"../../cmake-build-debug/NodeGL/Debug", f"../../cmake-build-debug/sxplayer/Debug", f"../../external/win64/lib"],
		...
		libraries=['ngfx', 'NodeGL', 'd3d12','dxgi','d3dcompiler','kernel32','user32','gdi32','winspool','shell32','ole32','oleaut32','uuid','comdlg32','advapi32',
			'sxplayer','avformat','avfilter','avcodec','avutil','pthread'],
